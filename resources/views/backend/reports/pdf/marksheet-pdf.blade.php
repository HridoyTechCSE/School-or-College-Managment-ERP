    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Manage  Marksheet genarate</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Marksheet genarate</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <section class="col-md-12 connectedSortable">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-teal"> Marksheet genarate List</h3>
                            ...
                            <div class="card-body">
                                <div style="border: solid 2px; padding:7px;">
                                    <div class="row">
                                        <div class="col-md-2 text-center">
                                            <img src="{{url('public/assets/backend/upload/abc_school.png')}}" alt="" style="width: 120px; height: 120px; float: right;">
                                        </div>
                                        <div class="col-md-2"></div>
                                        <div class="col-md-4 text-center" style="float: left;">
                                            <h4><strong>Nawab habibullah model School and collage</strong></h4>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <p style="text-align: right;"> <u><i>Print Date: </i></u> {{date("d M Y")}} </p>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <table border="1" width="100%" cellpadding="9" cellspacing="2">
                                            @php
                                                $assign_student = App\Model\AssignStudent::where('year_id',$allmarks['0']->year_id)->where('class_id',$allmarks['0']
->class_id)->first();
                                            @endphp
                                            <tr>
                                                <td width="50%">Student ID</td>
                                                <td width="50%">{{$allmarks['0']['in_no']}}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tbody>
                                                @foreach($allGreads as $mark)
                                                    <tr>
                                                        ...
                                                        <td>{{number_format((float)$mark->grade_point,2)}} - {{ ($mark->grade_point == 5)?(number_format(
    (float)$mark->grade_point,2)):(number_format((float)$mark->grade_point+1,2) - (float)0.01) }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="col-md-12">
                                        <table border="1" width="100%" cellpadding="1" cellspacing="1">
                                            <tbody>
                                                @php
                                                    $total_grade = 0;
                                                    $point_for_letter_grade = (float)$total_grade/(float)$total_subject;
