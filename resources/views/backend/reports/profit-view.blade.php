                    ...
                    <section class="col-md-12 connectedSortable">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-teal"> Monthly/yearly profit List</h3>
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="date" name="start_date" id="start_date" class="form-control form-control-sm" autocomplete="off" placeholder="Start Date" >
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="control-label">End Date</label>
                                        <input type="date" name="end_date" id="end_date" class="form-control form-control-sm" autocomplete="off" placeholder="End Date" >
                                    </div>
