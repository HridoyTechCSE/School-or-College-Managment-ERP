                ...
                <div class="row">
                    ...
                    <section class="col-md-12 connectedSortable">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{(@$editData)?route('students.registation.update',$editData->student_id):route('students.registation.store')}}" method="post" id="addStudent" enctype="multipart/form-data">
                                    @csrf
