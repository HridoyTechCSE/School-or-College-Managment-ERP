...
class StudentRegController extends Controller
{
    ...
    public function store(Request $request){
        ...
        return redirect()->route('students.registation.view')->with('success','data inserted successfully');
    }
    ...
    public function update(Request $request, $student_id){
        DB::transaction(function () use($request, $student_id){
            ...
            if ($request->file('image')){
                ...
                $file = $request->file('image');
                @unlink('public/upload/student_images/' . $user->image);
                $filename = date('YmdHi').$file->getClientOriginalName();
                $file->move(public_path('upload/student_images'),$filename);
                $user['image']= $filename;
            }
        ...
        return redirect()->route('students.registation.view')->with('success','data updated successfully');
    }
    ...
    public function promotionStore(Request $request, $student_id){
        ...
        return redirect()->route('students.registation.view')->with('success','successfully promotion');
    }

    public function details($student_id){
        $data['details'] = $data['editData'] = AssignStudent::with(['student','discount'])->where('student_id',$student_id)->first();
