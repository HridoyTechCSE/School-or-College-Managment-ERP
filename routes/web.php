...
Route::prefix('setups')->group(function (){
    ...
    //Fee/
    Route::get('/fee/category/shift/view','Backend\Setup\FeeCategoryController@view')->name('setups.fee.category.view');
    Route::get('/fee/category/shift/add','Backend\Setup\FeeCategoryController@add')->name('setups.fee.category.add');
    Route::post('/fee/category/shift/store','Backend\Setup\FeeCategoryController@store')->name('setups.fee.category.store');
    Route::get('/fee/category/shift/edit/{id}','Backend\Setup\FeeCategoryController@edit')->name('setups.fee.category.edit');
    Route::post('/fee/category/shift/update/{id}','Backend\Setup\FeeCategoryController@update')->name('setups.fee.category.update');
    Route::get('/fee/category/shift/delete/{id}','Backend\Setup\FeeCategoryController@delete')->name('setups.fee.category.delete');
    ...
    Route::get('assign/subject/view','Backend\Setup\AssignSubjectController@view')->name('setup.assign.subject.view');
    Route::get('assign/subject/add','Backend\Setup\AssignSubjectController@add')->name('setup.assign.subject.add');
    Route::post('assign/subject/store','Backend\Setup\AssignSubjectController@store')->name('setup.assign.subject.store');
    Route::get('assign/subject/edit/{class_id}','Backend\Setup\AssignSubjectController@edit')->name('setup.assign.subject.edit');
    Route::post('assign/subject/update/{class_id}','Backend\Setup\AssignSubjectController@update')->name('setup.assign.subject.update');
    Route::get('assign/subject/delete/{class_id}','Backend\Setup\AssignSubjectController@delete')->name('setup.assign.subject.delete');
    Route::get('/assign/subject/details/{class_id}','Backend\Setup\AssignSubjectController@details')->name('setup.assign.subject.details');
    ...
    Route::prefix('students')->group(function (){
        Route::get('/reg/view','Backend\Student\StudentRegController@view')->name('students.registation.view');
        Route::get('/reg/add','Backend\Student\StudentRegController@add')->name('students.registation.add');
        Route::post('/reg/store','Backend\Student\StudentRegController@store')->name('students.registation.store');
        Route::get('/reg/edit/{student_id}','Backend\Student\StudentRegController@edit')->name('students.registation.edit');
        Route::post('/reg/update/{student_id}','Backend\Student\StudentRegController@update')->name('students.registation.update');
        Route::get('/year-class-wise','Backend\Student\StudentRegController@yearClassWise')->name('students.year.class.wise');
        Route::get('/reg/promotion/{student_id}','Backend\Student\StudentRegController@promotion')->name('students.registation.promotion');
        Route::post('/reg/promotion/{student_id}','Backend\Student\StudentRegController@promotionStore')->name('students.registation.promotion.store');
        Route::get('/reg/details/{student_id}','Backend\Student\StudentRegController@details')->name('students.registation.details');
        ...
        Route::post('/Roll/store','Backend\Student\StudentRollController@store')->name('students.store.view');

        ///student registration fee
        Route::get('/res/fee/view','Backend\Student\RegistationFeeController@view')->name('students.reg.fee.view');
        Route::get('/res/get-student','Backend\Student\RegistationFeeController@getStudent')->name('students.reg.fee.get-student');
        Route::get('/res/fee/payslip','Backend\Student\RegistationFeeController@payslip')->name('students.reg.fee.payslip');

        ///student mounthly fee
        ...
        Route::get('/monthly/fee/payslip','Backend\Student\MonthlyFeeController@payslip')->name('students.reg.monthly.payslip');
        ...
        Route::get('/exam/fee/payslip','Backend\Student\ExamFeeController@payslip')->name('students.reg.exam.payslip');
...
//Grade Point
    ...
    Route::prefix('accounts')->group(function () {
        ...
        Route::get('/student/fee/getstudent','Backend\Account\StudentFeeController@getStudent')->name('accounts.fee.get-student');
        ...
        Route::get('/employee/get-employee','Backend\Account\SalaryController@getStudent')->name('accounts.salary.get-employee');
